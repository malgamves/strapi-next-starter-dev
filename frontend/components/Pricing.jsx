export default async function Pricing({ content }) {
  return (
    <section className="py-20 dark:bg-black dark:text-gray-100">
      <div className="container px-4 mx-auto">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          ...
          <h2 className="text-4xl font-bold lg:text-5xl">{content.title}</h2>
        </div>
        <div className="flex flex-wrap items-stretch -mx-4">
			{content.plans.map((pricePlan) => (
				<div key={pricePlan.id}className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
				  <div className="space-y-2">
					<h4 className="text-2xl font-bold">{pricePlan.name}</h4>
					<span className="text-6xl font-bold">
					  {pricePlan.price}
					  <span className="text-sm tracking-wide">({pricePlan.pricePeriod})</span>
					</span>
				  </div>
