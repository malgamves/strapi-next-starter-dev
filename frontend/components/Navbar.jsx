  ...
  return (
	...
	<div className="container flex justify-between h-16 mx-auto">
		...
		{/* <ul className="items-stretch hidden space-x-3 lg:flex">
			<li className="flex">
				<a rel="noopener noreferrer" href="/blog" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Blog</a>
			</li>
			<li className="flex">
